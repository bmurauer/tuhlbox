...
class TestTrees(unittest.TestCase):
    ...
    def test_pos_extraction(self) -> None:
        ...
        documents = [[nltk.Tree.fromstring("(S (NP I) (VP (V saw) (NP him)))")]]
        expected = [["NP", "V", "NP"]]
        actual = transformer.transform(documents)
        self.assertEqual(actual, expected)
    ...
    def test_pos_short_chains(self) -> None:
        ...
        transformer = TreeChainTransformer(max_length=2, combine_chain_elements=" ")
        documents = [
            # document 1
            [
                #  tree 1
        ...
        expected = [
            ...
            [
                # tree 1
                ["S DP", "DP D", "DP NP", "S VP", "VP V", "VP DP", "DP D", "DP NP"]
            ],
            # document 2
            [
                # tree 2
    ...
    def test_pos_short_chains_nocombine(self) -> None:
        ...
        transformer = TreeChainTransformer(max_length=2, combine_chain_elements=None)
        documents = [
            # document 1
            [
                #  tree 1
    ...
    def test_pos_long_chains(self) -> None:
        ...
        transformer = TreeChainTransformer(max_length=None, combine_chain_elements=" ")
        documents = [
            # document 1
            [
                #  tree 1
